...
/*!*******************************!*\
  !*** ./src/vue/util/index.js ***!
  \*******************************/
/*! exports provided: proxy, getType, nextTick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"proxy\", function() { return proxy; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getType\", function() { return getType; });\n/* harmony import */ var _nextTick__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nextTick */ \"./src/vue/util/nextTick.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"nextTick\", function() { return _nextTick__WEBPACK_IMPORTED_MODULE_0__[\"nextTick\"]; });\n\nconst proxy = (vm, source, data) => {\n    Object.keys(data).forEach(key => {\n        let item = data[key];\n        Object.defineProperty(vm, key, {\n          get() {\n            return item;\n          },\n          set(newVal) {\n              console.log(vm);\n            vm[source][key] = newVal; \n          },\n        });\n    })\n}\n\nconst getType = data => {\n    return /\\[object (.+)\\]/.exec(Object.prototype.toString.call(data))[1].toLowerCase();\n}\n\n\n\n\n//# sourceURL=webpack:///./src/vue/util/index.js?");

/***/ }),

/***/ "./src/vue/util/nextTick.js":
/*!**********************************!*\
  !*** ./src/vue/util/nextTick.js ***!
  \**********************************/
